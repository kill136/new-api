...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		logRoute.GET("/detail", middleware.AdminAuth(), controller.GetRequestLogDetail)
		logRoute.GET("/self/detail", middleware.UserAuth(), controller.GetUserRequestLogDetail)
